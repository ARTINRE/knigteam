<?php
ob_start();
define('API_KEY','264444666:AAGxB19Jj6DlvBXmsdlB2mRn55WiYLCQOww');
$admin = "98193019";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'سازنده','url'=>'https://telegram.me/SHARK_AA']
        ],
        [
          ['text'=>'کانال ','url'=>'https://telegram.me/knigteam']
        ]
      ]
    ])
  ]);
